...
export default function UpdateForm({ responses }: any) {
	...
	const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
		...
		try {
			const response = await axios.patch(
				`${process.env.NEXT_PUBLIC_LARAVEL_BACKEND_API_URL}/products/${responses.data.id}`,
				formData,
				{
					...
					<form
						...
						<div className="w-full flex items-center gap-2">
							<div className="relative w-full flex flex-col gap-3">
								<div>
									<input
										placeholder="Name"
										type="text"
										defaultValue={responses.data.name}
							...
							<div className="relative w-full">
								<select
									defaultChecked={responses.data.category}
							...
							<div className="relative w-full">
								<select
									defaultChecked={responses.data.setCategory}
						...
						<div className="w-full flex items-center gap-2">
							<div className="relative w-full">
								<textarea
									defaultValue={responses.data.shortDescription}
						...
						<div className="relative w-full">
							<textarea
								defaultValue={responses.data.longDescription}
						...
						<div className="mb-5">
							...
							<input
								type="file"
								accept="image/*"
								defaultValue={responses.data.image}
								multiple
